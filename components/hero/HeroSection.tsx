  ...
  return (
    <section id="home" className={styles.hero} ref={sectionRef}>
      ...
      <div className={styles.content}>
        ...
        >
          <h1 className={styles.name}>Hassan Mehmood</h1>
          <h2 className={styles.title}>Data Science Enthusiast, MERN Stack Developer, and Cloud Engineer</h2>
        </motion.div>
        ...
        >
          <a 
            href="https://drive.google.com/file/d/1AlbyMxPGbRnLQrpVTK1KpvNJL7gHk3bG/view" 
          ...
          <div className={styles.socialLinks}>
            <a
              href="https://github.com/HassanMehmood-star"
              target="_blank"
              rel="noopener noreferrer"
            ...
            <a
              href="https://www.linkedin.com/in/hassanmehmood9789"
              target="_blank"
              rel="noopener noreferrer"
              className={styles.socialLink}
              aria-label="LinkedIn"
